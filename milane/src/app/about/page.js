...
const AboutUs = () => {
  return (
    ...
    <div className="flex flex-col items-center justify-center  p-5  text-white mt-[100px] md:h-screen w-full  ">
      <h1 className="text-6xl font-bold text-center mb-6 text-[#F4BE39]">About Us</h1>
      
      <section className="text-center max-w-2xl mx-auto mb-12">
        <p className="text-3xl text-[#F4BE39] text-white mb-4">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="p-6">
          <h2 className="text-6xl font-bold mb-4 text-[#F4BE39]">Our Mission</h2>
        ...
        <div className="p-6">
          <h2 className="text-6xl font-bold mb-4 text-[#F4BE39]">Our Story</h2>
          <p className="text-white">
      ...
      <section className="text-center my-12">
        <h2 className="text-6xl text-[#F4BE39] font-bold mb-6">Why Choose Milane?</h2>
      ...
      <section className="text-center">
        <h2 className="text-6xl text-[#F4BE39] font-bold mb-6">Join Us at Milane</h2>
